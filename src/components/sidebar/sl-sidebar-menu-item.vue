<template>
  <div class="sidebar-menu-item" :class="{'sidebar-menu-item_active': active}">
    <svg
...
.sidebar-menu-item {
  ...
  &:hover {
    font-weight: bold;
    background: rgba(119, 119, 119, 0.151);
    transition-duration: 0.1s;
  }
  &__title {
    font-size: 12px;
...
.sidebar-menu-item_active{
  border: solid 2px rgb(149, 214, 163);
  color: rgb(149, 214, 163);
  svg { 
    fill: rgb(149, 214, 163);
  }
}
</style>